...
describe('groupform', () ->
  beforeEach(module('app.groupform'))
  ...
  describe('with a null item', () ->
    beforeEach( () ->
      @scope.item = null
      @element = @compile("<div group-form item=\"item\"></div>")(@scope)
      @scope.$digest()
    )
